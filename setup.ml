...
(* OASIS_START *)
(* DO NOT EDIT (digest: 4b3276b70568719274acfcfe3081756e) *)
(*
...
let setup_t =
  {
                 ...
                 CustomPlugin.cmd_main =
                   [
                      (OASISExpr.EBool true,
                        ("make", ["-C"; "doc"; "gpr_manual.pdf"]))
                   ];
                 cmd_clean =
                   [
                      (OASISExpr.EBool true,
                        Some (("make", ["-C"; "doc"; "clean"])))
                   ];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              })
       ];
     ...
     package =
       {
          ...
          copyrights =
            ["(C) 2008-2015 Markus Mottl <markus.mottl@gmail.com>"];
          maintainers = ["Markus Mottl <markus.mottl@gmail.com>"];
          authors = ["Markus Mottl <markus.mottl@gmail.com>"];
          homepage = Some "http://mmottl.github.io/gpr";
          bugreports = Some "https://github.com/mmottl/gpr/issues";
          synopsis =
          ...
          tags = [];
          categories = [];
          files_ab = ["src/gpr_version.ml.ab"];
          sections =
            [
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage
                             ("lacaml",
                               Some (OASISVersion.VGreaterEqual "9.2.3"));
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [InternalLibrary "gpr"; FindlibPackage ("str", None)];
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "ocamldoc"];
                      bs_interface_patterns =
                        [
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "test";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "gpr"];
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "ocamldoc"];
                      bs_interface_patterns =
                        [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "save_data.ml"});
               Test
                 ({
                     cs_name = "test_derivatives";
                     cs_data = PropList.Data.create ();
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "GPR manual";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [("doc/gpr_manual.pdf", None)];
                      doc_build_tools =
                        [
               ...
               SrcRepo
                 ({
                   ...
                   {
                      src_repo_type = Git;
                      src_repo_location = "https://github.com/mmottl/gpr.git";
                      src_repo_browser = Some "https://github.com/mmottl/gpr";
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "\001&U\158\016i\238&\185\244\203\183\015\004\015l";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
