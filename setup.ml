...
(* # 21 "/Users/mmottl/local/darwin11.3.0/src/oasis-0.3.0~rc6/src/plugins/custom/CustomPlugin.ml" *)
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "http://www.bitbucket.org/mmottl/gpr";
          synopsis =
     ...
     oasis_digest = Some "d\001Ð\\)\147Wm3}\143\143WY|\001";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
