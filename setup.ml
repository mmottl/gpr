...
(* OASIS_START *)
(* DO NOT EDIT (digest: 5e148d237e229c4a3f74877e425d8a16) *)
(*
...
let setup_t =
  {
     ...
     doc =
       [
          ("API", OCamlbuildDocPlugin.doc_build ".");
          ("gpr_manual",
     ...
     clean_doc =
       [
          ("API", OCamlbuildDocPlugin.doc_clean ".");
          ("gpr_manual",
     ...
     package =
       {
          ...
          homepage = Some "https://bitbucket.org/mmottl/gpr";
          synopsis =
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "test_derivatives.ml";
                      });
               Executable
                 ({
                     cs_name = "save_data";
               ...
               SrcRepo
                 ({
                   ...
                   {
                      src_repo_type = Hg;
                      src_repo_location = "ssh://hg@bitbucket.org/mmottl/gpr";
                      src_repo_browser =
                        Some "https://bitbucket.org/mmottl/gpr";
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\005Ï\147\007T\r\158>Ñ\134*Ö\128È\142S";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
