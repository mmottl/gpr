...
module Const = struct
  include Fitc_gp.Make_deriv (Cov_const.Deriv)
...
module Lin_one = struct
  include Fitc_gp.Make_deriv (Cov_lin_one.Deriv)
...
module Lin_ard = struct
  include Fitc_gp.Make_deriv (Cov_lin_ard.Deriv)
...
module SE_iso = struct
  include Fitc_gp.Make_deriv (Cov_se_iso.Deriv)
