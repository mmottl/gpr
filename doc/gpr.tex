...
are provided in the bibliography.  Readers who would like to obtain a deeper
understanding of the methods from linear algebra (e.g.\ matrix factorizations)
used in the library may find a most comprehensive and detailed treatment in
\cite{MatrixAnalysis}.
